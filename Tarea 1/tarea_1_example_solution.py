...
def potencia_manual(base, potencia):
    ...
    for _ in range(potencia):
        ...
        for _ in range(base):
            suma += resultado  # Sumar resultado "base" veces
        resultado = suma  #
    return SUCCESS, resultado


if __name__ == "__main__":
    metodo = input("0 -> método separar_letras, 1 -> método potencia_manual: ")
    if metodo == "0":
        ...
        # Convertir base y potencia a int, ya que input recibe únicamente str
        try:
            base = int(base)
